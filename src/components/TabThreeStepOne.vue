...
<template>
  <div>
    <div class="text-h6 font-weight-light">Nueva oferta</div>
    <div class="mt-8">
        ...
        <v-row class="pb-4">
          ...
          <v-col cols="12" sm="6" :class="$vuetify.breakpoint.xs ? 'px-0' : 'pr-0'">
            <v-select
              ...
              v-model="form.economic"
              :items="items"
              label="Sector principal de la oferta"
              outlined
            ></v-select>
            <v-select
            ...
            <div class="dollar-input mt-2">
              <div class="d-flex justify-space-between">
                <div style="color: #666666;">Salario</div>
              </div>
              <v-row class="mt-1">
                <v-col cols="6" class="d-flex">
                  <span style="color: #666666;">Min</span>
                  <v-text-field
                    class="pl-2"
                    dense
                    hide-details
                ...
                <v-col cols="6" class="d-flex">
                  <span style="color: #666666;">Max</span>
                  <v-text-field
                    class="pl-2"
                    dense
                    hide-details
